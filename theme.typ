...
#let theme(
  ...
  set page(
    ...
    header: context {
      ...
      box(stroke: (bottom: 0.7pt), inset: 0.2em)[#text(font:"New Computer Modern" )[#author #h(1fr)#title]]
    },
  )
...
#let claim = theorem-style("claim", "Claim")
...
#let question = definition-style("questions", "Questions")
